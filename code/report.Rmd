...
dico <- read.csv(paste0(mainDirroot,"/data/dico_form4.xls.csv"), encoding="UTF-8", na.strings="NA")
data <- read.csv(paste0(mainDirroot,"/data/data2.csv"), encoding="UTF-8", na.strings="NA")
